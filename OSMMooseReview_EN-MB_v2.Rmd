...
The study area of this report is defined as all WMUs that intersect with the 
...
ab_prov %>%
  ...
  # Legend layer
  addLegend(data = ab_wmu_dens, position = "bottomleft", pal = pal_1, 
