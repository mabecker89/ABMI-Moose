...
As shown in Figure X, no clear trend in sex of calf ratios was observed either
...
```{r include=TRUE, echo=TRUE, message=FALSE, warning=FALSE, eval=TRUE, out.width="100%",fig.cap=c("Figure X. Moose Habitat Associations in Northern Alberta - Summer", "Figure X. Moose Habitat Associations in Northern Alberta - Winter")}
...
displays a map of the ABMI relative abundance predictions for moose across the 
OSR, using RC data from 2015-2017. Pixels depicted in red are predicted to have
the highest abundance for moose, whereas areas of dark blue moose are expected 
to be less abundant or absent. 
...
Eight of the documents we reviewed reported effects of moose selection or 
...
or other effects that existed prior to mine development. As aerial surveys using
the distance sampling method 
